...
# L2592 - notcurses/notcurses.h
const
  NCBOXMASK_TOP*    = 0x00000001'u32
  NCBOXMASK_RIGHT*  = 0x00000002'u32
  NCBOXMASK_BOTTOM* = 0x00000004'u32
  NCBOXMASK_LEFT*   = 0x00000008'u32
  NCBOXGRAD_TOP*    = 0x00000010'u32
  NCBOXGRAD_RIGHT*  = 0x00000020'u32
  NCBOXGRAD_BOTTOM* = 0x00000040'u32
  NCBOXGRAD_LEFT*   = 0x00000080'u32
  NCBOXCORNER_MASK* = 0x00000300'u32
  NCBOXCORNER_SHIFT* = 8'u32
