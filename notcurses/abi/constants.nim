...
const
  ...
  NCBOXHEAVYW*  = "┏┓┗┛━┃".cstring
  NCBOXROUNDW*  = "╭╮╰╯─│".cstring
  NCBOXDOUBLEW* = "╔╗╚╝═║".cstring
  NCBOXASCIIW*  = "/\\\\/-|".cstring
  NCBOXOUTERW*  = "🭽🭾🭼🭿▁🭵🭶🭰".cstring

  # L17 - notcurses/ncseqs.h
  NCWHITESQUARESW*   = "◲◱◳◰".cstring
  NCWHITECIRCLESW*   = "◶◵◷◴".cstring
  NCCIRCULARARCSW*   = "◜◝◟◞".cstring
  NCWHITETRIANGLESW* = "◿◺◹◸".cstring
  NCBLACKTRIANGLESW* = "◢◣◥◤".cstring
  NCSHADETRIANGLESW* = "🮞🮟🮝🮜".cstring

  # L25 - notcurses/ncseqs.h
  NCBLACKARROWHEADSW* = "⮝⮟⮜⮞".cstring
  NCLIGHTARROWHEADSW* = "⮙⮛⮘⮚".cstring
  NCARROWDOUBLEW*     = "⮅⮇⮄⮆".cstring
  NCARROWDASHEDW*     = "⭫⭭⭪⭬".cstring
  NCARROWCIRCLEDW*    = "⮉⮋⮈⮊".cstring
  NCARROWANTICLOCKW*  = "⮏⮍⮎⮌".cstring
  NCBOXDRAWW*         = "╵╷╴╶".cstring
  NCBOXDRAWHEAVYW*    = "╹╻╸╺".cstring

  # L35 - notcurses/ncseqs.h
  NCARROWW*     = "⭡⭣⭠⭢⭧⭩⭦⭨".cstring
  NCDIAGONALSW* = "🮣🮠🮡🮢🮤🮥🮦🮧".cstring

  # L39 - notcurses/ncseqs.h
  NCDIGITSSUPERW* = "⁰¹²³⁴⁵⁶⁷⁸⁹".cstring
  NCDIGITSSUBW*   = "₀₁₂₃₄₅₆₇₈₉".cstring

  # L43 - notcurses/ncseqs.h
  NCASTERISKS5* = "🞯🞰🞱🞲🞳🞴".cstring
  NCASTERISKS6* = "🞵🞶🞷🞸🞹🞺".cstring
  NCASTERISKS8* = "🞻🞼✳🞽🞾🞿".cstring
  ...
  NCEIGHTHSL* = "▏▎▍▌▋▊▉█".cstring
  NCEIGHTHSR* = "▕🮇🮈▐🮉🮊🮋█".cstring
  NCHALFBLOCKS* = " ▀▄█".cstring
  NCQUADBLOCKS* = " ▘▝▀▖▌▞▛▗▚▐▜▄▙▟█".cstring
  NCSEXBLOCKS*  = " 🬀🬁🬂🬃🬄🬅🬆🬇🬈🬊🬋🬌🬍🬎🬏🬐🬑🬒🬓▌🬔🬕🬖🬗🬘🬙🬚🬛🬜🬝🬞🬟🬠🬡🬢🬣🬤🬥🬦🬧▐🬨🬩🬪🬫🬬🬭🬮🬯🬰🬱🬲🬳🬴🬵🬶🬷🬸🬹🬺🬻█".cstring
  ...
  NCSEGDIGITS* =
    ("\u{0001fbf0}\u{0001fbf1}\u{0001fbf2}\u{0001fbf3}\u{0001fbf4}" &
     "\u{0001fbf5}\u{0001fbf6}\u{0001fbf7}\u{0001fbf8}\u{0001fbf9}").cstring

  # L79 - notcurses/ncseqs.h
  NCSUITSBLACK* = "\u2660\u2663\u2665\u2666".cstring # ♠♣♥♦
  NCSUITSWHITE* = "\u2661\u2662\u2664\u2667".cstring # ♡♢♤♧
  NCCHESSBLACK* = "\u265f\u265c\u265e\u265d\u265b\u265a".cstring # ♟♜♞♝♛♚
  NCCHESSWHITE* = "\u265f\u265c\u265e\u265d\u265b\u265a".cstring # ♙♖♘♗♕♔
  NCDICE*       = "\u2680\u2681\u2682\u2683\u2684\u2685".cstring # ⚀⚁⚂⚃⚄⚅
  NCMUSICSYM*   = "\u2669\u266A\u266B\u266C\u266D\u266E\u266F".cstring # ♩♪♫♬♭♮♯
